...
SECRET_KEY = '5y!mi-u-d-9lad6fw1l1c$xkbs!&%^h0rox_0i2ony1h=t#u31'
...
ROOT_URLCONF = 'chatOverflow_proj.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cysxcdsu',
        'USER': 'cysxcdsu',
        'PASSWORD': 'L7NuZOttAw_QaIlTdXakyKXW2xerb-56',
        'HOST': 'drona.db.elephantsql.com', #can also be localhost
        'PORT': 5432,
    }
}
